...
class MGFM(nn.Module):
    def __init__(self, in_channels):
        ...
        self.mlp_x = Mlp2(in_features=self.in_channel * 2, out_features=self.in_channel)
        self.mlp_y = Mlp2(in_features=self.in_channel * 2, out_features=self.in_channel)
        self.sigmoid = nn.Sigmoid()

        self.mlp = Mlp2(in_features= in_channels,out_features=in_channels)
...
class UNetFormer(nn.Module):
    def __init__(self,
        ...
        mask_in_chans=16
        self.height_encoder = resnet50(pretrained=False,in_channels=1)
        ...
        self.fusion_1 = MGFM(256)
        self.fusion_2 = MGFM(256)
        self.fusion_3 = MGFM(256)
        self.fusion_4 = MGFM(256)
    ...
    def forward(self, x, depth, mask,ufzs):
        ...
        [feat1_sar, feat2_sar, feat3_sar, feat4_sar, feat5_sar] = self.height_encoder(depth)
        ...
        fusion_feat4 = self.fusion_1(res1, feat2_sar)
        fusion_feat3 = self.fusion_2(res2, feat3_sar)
        fusion_feat2 = self.fusion_3(res3, feat4_sar)
        fusion_feat1 = self.fusion_4(res4, feat5_sar)

        x = self.decoder(fusion_feat1, fusion_feat2, fusion_feat3, fusion_feat4, h, w)
        return x